...
class ImagePickerDemoScreen extends StatefulWidget {
  static String name = 'ImagePickerDemo';
  static String path = '/image_picker_demo';
  const ImagePickerDemoScreen({super.key});

  @override
  State<StatefulWidget> createState() => _ImagePickerDemoScreenState();
}
...
class _ImagePickerDemoScreenState extends State<ImagePickerDemoScreen> {
  ...
  Widget _previewImages() {
    final Text? retriveError = _getRetrieveErrorWidget();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(ImagePickerDemoScreen.name),
          actions: [
            ElevatedButton(
                onPressed: () {
                  setState(() {
...
class AspectRatioVideoState extends State<AspectRatioVideo> {
  ...
  Widget build(BuildContext context) {
    if (initialized) {
      ...
      return Center(
        child: Text("Controller Not Initialized"),
      );
    }
  }
}
